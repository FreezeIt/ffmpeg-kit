Pod::Spec.new do |s|
  ...
  #s.source              = { :path => '.' }
  s.source              = {
    :http => 'https://github.com/FreezeIt/ffmpeg-kit/releases/download/v6.0/ffmpeg-kit-full-gpl-6.0-ios-xcframework-fixed.zip'
  }
  ...
  s.subspec 'full-gpl' do |ss|
    ...
    ss.ios.deployment_target = '12.1'
    ss.vendored_frameworks = 'https://github.com/FreezeIt/ffmpeg-kit/releases/download/v6.0/ffmpeg-kit-full-gpl-6.0-ios-xcframework.zip'
  end
